                ...
                if thread.smc == 'TIGO':
                    ...
                    if nmbr[0] + nmbr[1] + nmbr[2] == '075' or nmbr[0] + nmbr[1] \
                        ...
                        if self.mn1 == []:
                            ...
                            self.responder()
                            self.pb.setValue(int(100 / 6))
                        elif self.mn1 == ['*150*00#']:
                            self.opt = '1'
                            self.mn1.append(self.opt)
                            self.responder()
                            self.pb.setValue(int(200 / 6))
                        elif self.mn1 == ['*150*00#', '1']:
                            self.opt = '1'
                            self.mn1.append(self.opt)
                            self.responder()
                            self.pb.setValue(int(300 / 6))
                        elif self.mn1 == ['*150*00#', '1', '1']:
                            self.opt = pnm
                            self.mn1.append(self.opt)
                            self.responder()
                            self.pb.setValue(int(400 / 6))
                        elif self.mn1 == ['*150*00#', '1', '1', pnm]:
                            self.opt = amnt
                            self.mn1.append(self.opt)
                            self.responder()
                            self.pb.setValue(int(500 / 6))
                    ...
                    if self.sto == True:
                        ...
                        if self.mn1 == []:
                            ...
                            self.responder()
                            self.pb.setValue(int(300 / 7))
                        elif self.mn1 == ['*150*00#', '1', '5']:
                            self.opt = chc3
                            self.mn1.append(self.opt)
                            self.responder()
                            self.pb.setValue(int(400 / 7))
                        elif self.mn1 == ['*150*00#', '1', '2', chc3]:
                            self.opt = pnm
                            self.mn1.append(self.opt)
                            self.responder()
                            self.pb.setValue(int(500 / 7))
                        elif self.mn1 == ['*150*00#', '1', '2', chc3, pnm]:
                            self.opt = amnt
                            self.mn1.append(self.opt)
                            self.responder()
                            self.pb.setValue(int(600 / 7))
...
class Detectdevice():
    ...
    def chksmcd(self):
        try:
            ...
            if n[1] == 'READY':
                self.sim = 'SIMCARD'
                ids = ['64002', '64004','64003']
                idsn = ['TIGO','VODACOM','ZANTEL']
                try:
